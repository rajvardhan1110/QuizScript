    ...
    useEffect(() => {
        const fetchAdmin = async () => {
            try {
                ...
                setError(err.response?.data?.msg || "Failed to fetch admin info");
                setMessage("");
            }
        };
        fetchAdmin();
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-50 py-8">
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden p-6">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="w-20 h-20 bg-red-600 text-white rounded-full flex items-center justify-center shadow-lg mb-4">
                        <FaUserTie size={28} />
                    </div>
                    <h2 className="text-2xl font-bold text-gray-800">Educator Profile</h2>
                ...
                <div className="border-t border-gray-200 pt-6">
                    ...
                    {!showDeleteInput ? (
                        ...
                        <div className="space-y-4">
                            <p className="text-sm text-gray-600">This will permanently delete your educator account and all associated data.</p>
                            <input
                                type="password"
